...
public class BucketOfTranquilizerItem extends Item {
    public BucketOfTranquilizerItem(Properties properties) {
        super(properties);
    }

    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(new TranslatableComponent("item.onthebrink.bucket_of_tranquilizer.desc_0")
                .withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));

        tooltip.add(new TranslatableComponent("item.onthebrink.bucket_of_tranquilizer.desc_1")
                .withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));

        tooltip.add(Component.nullToEmpty("")); // empty line

        tooltip.add(new TranslatableComponent("item.onthebrink.bucket_of_tranquilizer.desc_2")
                .withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));
        tooltip.add(new TranslatableComponent("item.onthebrink.bucket_of_tranquilizer.desc_3")
                .withStyle(ChatFormatting.DARK_GRAY, ChatFormatting.ITALIC));
    }
    ...
    public ItemStack finishUsingItem(ItemStack stack, Level world, LivingEntity entity) {
        if (!world.isClientSide) {
            ...
            entity.addEffect(new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 20 * 60, 16));
            entity.addEffect(new MobEffectInstance(MobEffects.WEAKNESS, 20 * 300, 0));
            entity.addEffect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 20 * 300, 0));
            entity.addEffect(new MobEffectInstance(MobEffects.BLINDNESS, 20 * 60, 0));
            entity.addEffect(new MobEffectInstance(MobEffects.WITHER, 20 * 120, 0));
