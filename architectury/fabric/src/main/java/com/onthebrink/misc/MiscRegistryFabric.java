...
public class MiscRegistryFabric {
    public static void registerTreePlacerTypes() {
        ...
        MiscRegistry.COCONUT_TREE_TRUNK_PLACER = TrunkPlacerTypeInvoker.callRegister("onthebrink:coconut_tree_trunk_placer", CoconutTreeTrunkPlacer.CODEC);
        ...
        MiscRegistry.RUBBER_TREE_TRUNK_PLACER = TrunkPlacerTypeInvoker.callRegister("onthebrink:rubber_tree_trunk_placer", RubberTreeTrunkPlacer.CODEC);
        MiscRegistry.RUBBER_TREE_FOLIAGE_PLACER = FoliagePlacerTypeInvoker.callRegister("onthebrink:rubber_tree_foliage_placer", RubberTreeFoliagePlacer.CODEC);
